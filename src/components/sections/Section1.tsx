        ...
        <div className="flex gap-2 max-555-align">
            <div className="w-[220px] max-[555]:w-[300px]">
                <div
                    ...
                    <div>
                        <Button variant="ghost" className="bg-gray-200 dark:bg-transparent h-8 uppercase font-semibold my-3 cursor-pointer">Web module</Button>
                        <Button variant="ghost" className="bg-sky-100 dark:bg-transparent dark:text-neutral-300 h-8 uppercase font-semibold cursor-pointer">$150 - $300/HR</Button>
                    </div>
                </div>
