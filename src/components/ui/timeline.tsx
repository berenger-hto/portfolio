...
function TimelineContent({
  ...
  return (
    <div
      ...
      className={cn("text-muted-foreground text-base max-[670px]:text-sm", className)}
      {...props}
    />
  )
}
...
function TimelineDate({
  ...
  return (
    <time
      ...
      className={cn(
        "text-muted-foreground mb-1 block text-lg max-[670px]:text-sm font-medium group-data-[orientation=vertical]/timeline:max-sm:h-4",
        className
      )}
      {...props}
    />
...
function TimelineTitle({
  ...
  return (
      <TextShimmer
          ...
          className={cn("text-xl font-medium max-[670px]:text-sm", className)}
          {...props}
      >
          {(children as string)}
      </TextShimmer>
